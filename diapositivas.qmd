---
title: "Introducción al análisis de datos con R, _3ª versión_"
...
:::: {.pad}
Encuentra todo sobre el curso [en este post](https://bastianolea.rbind.io/blog/curso_r_intro_3/) de mi blog.
::::

:::: {.pad style="max-width: 50%;"}
::: {.boton}
[{{< fa book-open >}} Curso](https://bastianolea.rbind.io/blog/curso_r_intro_3/)
:::
...
::: {.boton}
[{{< fa chalkboard-user >}} Diapositivas](https://bastianolea.github.io/curso_intro_R_3)
:::
...
Existen muchas diferencias entre _hacer_ algo y **programarlo:**

::: {.incremental}
- Aprender a programar es un **cambio de perspectiva**: pasamos de _hacer_ cosas a _planificar_ cosas 💅🏼
- Desde la mera **Acción** 🔧 a la **Instrucción** 🧠 y luego al **Proceso** ⚙️
...
**Nuevo en RStudio:** _Posit Assistant,_ asistente de inteligencia artificial integrado con tu código y datos.

![](imagenes/rstudio_posit_assistant.png){.centro style="width: 800px;"}

Más información [en esta publicación.](https://bastianolea.rbind.io/blog/posit_assistant/)
...
::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/pobreza/estimaciones_pobreza.xlsx" target="_blank"> {{< fa file-download >}} Descargar datos de pobreza en Excel</a>
:::
...
Se lee: _al `objeto` le aplicamos la `funcion()`_
...
Usaremos los datos de **pobreza** del [Ministerio Desarrollo Social y Familia](https://bidat.gob.cl/directorio/Pobreza%20comunal/estimaciones-de-pobreza-comunal-2022) que vimos antes. Si no los cargaste, [descárgalos](https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/pobreza/estimaciones_pobreza.xlsx) y los cargas así:
...
En el fondo, cuando filtremos datos, las **columnas** de un _dataframe_ serán **vectores**, y las comparaciones se harán sobre cada uno de los valores de la columna, entregando un resultado `TRUE` o `FALSE` para cada fila, que luego usaremos para quedarnos sólo con las filas que cumplen la condición que queremos.
...
::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/censo/educacion.xlsx" target="_blank"> {{< fa file-download >}} Descargar datos de educación en Excel</a>
:::

```{r}
educacion <- readxl::read_xlsx("datos/censo/educacion.xlsx")
...
::: {.fragment}
![](imagenes/left_join.png){.centrar style='max-height: 340px;'}
:::

<br>

::: {.fragment .boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/clasificacion/clasificacion.xlsx" target="_blank"> {{< fa file-download >}} Descargar datos de clasificación comunal en Excel</a>
:::
...
Veamos un ejemplo donde transformamos los [datos de **estimaciones de población** del INE](https://www.ine.gob.cl/estadisticas/sociales/demografia-y-vitales/proyecciones-de-poblacion), desde un formato **ancho** (años en columnas) a uno **largo** (años en filas).

::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/estimaciones/estimaciones_poblacion.xlsx" target="_blank"> {{< fa file-download >}} Descargar datos de estimaciones de población en Excel</a>
:::
...
poblacion <- read_xlsx("datos/estimaciones/estimaciones_poblacion.xlsx")
...
::: { .boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/clasificacion/clasificacion.xlsx" target="_blank"> {{< fa file-download >}} Clasificaciones comunales</a>
:::

::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/estimaciones/estimaciones_poblacion.xlsx" target="_blank"> {{< fa file-download >}} Estimaciones de población</a>
:::

::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/censo/educacion.xlsx" target="_blank"> {{< fa file-download >}} Escolaridad por comuna</a>
:::

::: {.boton}
<a href="https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/censo/genero.xlsx" target="_blank"> {{< fa file-download >}} Población según género</a>
:::
...
- Prodice gráficos por medio de **capas**
...
::: {.incremental style="font-align: right;"}
- Datos [línea 1]{.linea}
...
grafico_textos <- grafico_color +
  labs(x = "Ancho del sépalo", 
       y = "Largo del sépalo", 
       color = "Especies",
       title = "Gráfico de dispersión",
       subtitle = "Iris Setosa")
...
Hoja de referencia de los elementos de temas en `{ggplot2}`, fuente: [Isabella Benabaye](https://isabella-b.com/blog/ggplot2-theme-elements-reference/)

<br>

![](imagenes/ggplot2-theme-elements-reference.png)
...
::: {.aside}
Acá hay una [lista de extensiones de `ggplot2`](https://bastianolea.rbind.io/blog/ggplot_extensiones/)
:::
...
:::: {.columns}
::: {.incremental .column width=70%}
- El [paquete `{sf}`](https://r-spatial.github.io/sf/) entrega herramientas para trabajar con datos geoespaciales en R
- Permite representar características espaciales en _data frames_
...
::: {.boton .fragment}
[{{< fa file-lines >}} Ver tutorial](https://bastianolea.rbind.io/blog/mapas_sf/)
:::
...
::: {.boton .absolute top=-1% right=0%}
[{{< fa file-lines >}} Ver tutorial](https://bastianolea.rbind.io/blog/tutorial_mapa_urbano/)
:::


El [paquete `{chilemapas}`](https://pacha.dev/chilemapas/) ofrece funciones que simplifican la obtención de mapas de Chile en R.
...
::: {.boton }
[{{< fa file-lines >}} Variables educacionales Censo 2024](https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/censo/P7_Educacion.xlsx)
:::

::: {.boton }
[{{< fa file-lines >}} Estimación de pobreza multidimensional 2022](https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/pobreza/estimaciones_indice_pobreza_multidimensional_comunas_2022.xlsx)
:::

::: {.boton }
[{{< fa file-lines >}} Clasificaciones comunales 2024](https://github.com/bastianolea/curso_intro_R_3/raw/main/datos/clasificacion/ClasificacionComunasPNDR_Censo2024.xlsx)
:::
